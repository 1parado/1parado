...
## 关于我🧭
- 📚 2026年 现在是研二（在读研究生），主攻后端开发，熟悉 Java、Spring Boot、分布式系统基础。
- 💡 喜欢算法和数据结构，平时刷题并优化工程实践。
- 🌱 目前已经有过一段小厂实习经历，目前在中厂进行寒假实习，最终目标成都团子！！！。
...
- 消息/中间件：`RocketMQ` · `Kafka`
- 数据库：`MySQL` · `Redis`· `PostGresql`
- 工具：`Maven` · `Git` · `Docker` · `Linux`
---

## 项目速览
- **[zzu_quick_lession](https://github.com/1parado/quick_lession_zzu)** — 仿郑州大学教务管理系统
- **[zzu_survey_system](https://github.com/1parado/survey-system)** ——仿郑州大学调查问卷系统
